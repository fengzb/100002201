...
![d98d65bef3719e175f16bdb5901f37a6.png][]
...
然而，还是有一些人会错误地理解CAP定理，甚至误用。Cloudera工程博客中，[CAP Confusion: Problems with ‘partition tolerance’][CAP Confusion_ Problems with _partition tolerance]一文中对此有详细的阐述。

在谷歌的[Transaction Across DataCenter视频][Transaction Across DataCenter]中，我们可以看到下面这样的图。这个是CAP理论在具体工程中的体现。

![f62e32b1a3d81db6ae24b174f1b727b8.png][]

## [Fallacies of Distributed Computing][]

本文是英文维基百科上的一篇文章。它是Sun公司的[劳伦斯·彼得·多伊奇（Laurence Peter Deutsch）][Laurence Peter Deutsch]等人于1994~1997年提出的，讲的是刚刚进入分布式计算领域的程序员常会有的一系列错误假设。
...
而[加勒思·威尔逊（Gareth Wilson）的文章][Gareth Wilson]则用日常生活中的例子，对这些点做了更为通俗的解释。
...
可以参考Lamport时钟和Vector时钟，还可以看看[Dynamo论文][Dynamo]。

 *  **容错的压力（The basic tension of fault tolerance）** 。能在不降级的情况下容错的系统一定要像没有错误发生的那样运行。这就意味着，系统的某些部分必须冗余地工作，从而在性能和资源消耗两方面带来成本。

最终一致性以及其他技术方案在以系统行为弱保证为代价，来试图避免这种系统压力。阅读[Dynamo论文][Dynamo]和帕特·赫尔兰（Pat Helland）的经典论文[Life Beyond Transactions][]能获很得大启发。

 *  **基本原语（Basic primitives）** 。在分布式系统中几乎没有一致认同的基本构建模块，但目前在越来越多地在出现。比如Leader选举，可以参考[Bully算法][Bully]；分布式状态机复制，可以参考[维基百科][Link 1]和[Lampson的论文][Lampson]，后者更权威，只是有些枯燥。
...
它是[分布式系统基础课][Link 2]的课程提纲，也是一份很棒的分布式系统介绍，几乎涵盖了所有知识点，并辅以简洁并切中要害的说明文字，非常适合初学者提纲挈领地了解知识全貌，快速与现有知识结合，形成知识体系。此外，还可以把它作为分布式系统的知识图谱，根据其中列出的知识点一一搜索，你能学会所有的东西。
...
## [Distributed Systems: Principles and Paradigms][Distributed Systems_ Principles and Paradigms]
...
但本书不是一本指导“如何做”的手册，仅适合系统性地学习基础知识，了解编写分布式系统的基本原则和逻辑。中文翻译版为[《分布式系统原理与范型》（第二版）][Link 3]。

## [Scalable Web Architecture and Distributed Systems][]

这是一本免费的在线小册子，其中文翻译版为[可扩展的Web架构和分布式系统][Web]。
...
这本书是2017年3月份出版的，目前还没有中译版，不过英文也不难读。非常推荐。这里有[这本书的PPT][PPT]，你可从这个PPT中管中窥豹一下。
...
![a321a64415498cbbf5222b3971accabb.png][]
**插图来自电影《摔跤吧！爸爸》** 

《分布式系统架构的本质》系列文章的目录如下，方便你查找自己关注的内容。

 *  [分布式系统架构的冰与火][Link 4]
 *  [从亚马逊的实践，谈分布式系统的难点][Link 5]
 *  [分布式系统的技术栈][Link 6]
 *  [分布式系统关键技术：全栈监控][Link 7]
 *  [分布式系统关键技术：服务调度][Link 8]
 *  [分布式系统关键技术：流量与数据调度][Link 9]
 *  [洞悉PaaS平台的本质][PaaS]
 *  [推荐阅读：分布式系统架构经典资料][Link 10]
 *  [推荐阅读：分布式数据调度相关论文][Link 11]


[CAP]: https://en.wikipedia.org/wiki/CAP_theorem
[d98d65bef3719e175f16bdb5901f37a6.png]: https://static001.geekbang.org/resource/image/d9/a6/d98d65bef3719e175f16bdb5901f37a6.png
[CAP Confusion_ Problems with _partition tolerance]: http://blog.cloudera.com/blog/2010/04/cap-confusion-problems-with-partition-tolerance/
[Transaction Across DataCenter]: http://www.youtube.com/watch?v=srOgpXECblk
[f62e32b1a3d81db6ae24b174f1b727b8.png]: https://static001.geekbang.org/resource/image/f6/b8/f62e32b1a3d81db6ae24b174f1b727b8.png
[Fallacies of Distributed Computing]: http://en.wikipedia.org/wiki/Fallacies_of_distributed_computing
[Laurence Peter Deutsch]: https://en.wikipedia.org/wiki/L_Peter_Deutsch
[Fallacies of Distributed Computing Explained]: http://www.rgoarchitects.com/Files/fallacies.pdf
[Gareth Wilson]: http://blog.fogcreek.com/eight-fallacies-of-distributed-computing-tech-talk/
...
[Life Beyond Transactions]: http://www.cloudtran.com/pdfs/LifeBeyondDistTRX.pdf
[Bully]: https://en.wikipedia.org/wiki/Bully_algorithm
[Link 1]: https://en.wikipedia.org/wiki/State_machine_replication
[Lampson]: https://www.microsoft.com/en-us/research/publication/how-to-build-a-highly-available-system-using-consensus/?from=http%3A%2F%2Fresearch.microsoft.com%2Fen-us%2Fum%2Fpeople%2Fblampson%2F58-consensus%2Facrobat.pdf
[FLP Impossibility Result]: https://groups.csail.mit.edu/tds/papers/Lynch/jacm85.pdf
[An introduction to distributed systems]: https://github.com/aphyr/distsys-class
[Link 2]: https://github.com/aphyr/distsys-class#review-1
...
[Link 3]: https://item.jd.com/10079452.html
...
[PPT]: http://www.antonfagerberg.com/files/intensive.pdf
[a321a64415498cbbf5222b3971accabb.png]: https://static001.geekbang.org/resource/image/a3/bb/a321a64415498cbbf5222b3971accabb.png
[Link 4]: https://time.geekbang.org/column/article/1411
[Link 5]: https://time.geekbang.org/column/article/1505
[Link 6]: https://time.geekbang.org/column/article/1512
[Link 7]: https://time.geekbang.org/column/article/1513
[Link 8]: https://time.geekbang.org/column/article/1604
[Link 9]: https://time.geekbang.org/column/article/1609
[PaaS]: https://time.geekbang.org/column/article/1610
[Link 10]: https://time.geekbang.org/column/article/2080
[Link 11]: https://time.geekbang.org/column/article/2421
